...
//   var buffer = Uint8List.fromList(valuesorted).buffer; // buffer bytes from list

//   if (flags == 0) {
//     // hr
//     var hrbuffer = ByteData.view(buffer, 1, 1); // get second byte
//     var hr = hrbuffer.getInt8(0); // recode as uint8
//     print(hr);
//   }
...
//     List<int> rrs = [];
//     for (var i = 0; i < nrr; i++) {
//       var rrbuffer = ByteData.view(buffer, 2 + (i * 2),
//           2); // get pairs of bytes counting since the 3rd byte
//       var rr = rrbuffer.getInt16(0); // recode as uint16
//       rrs.insert(i, rr);
//     }
//     print(rrs);
//   }
                  ...
                  (c) => CharacteristicTile(
                    ...
                    onReadPressed: () async {
                      try {
                        ...
                        final snackBar = snackBarGood("Read: Success  $value");
                        ...
                        builder: (c, snapshot) => IndexedStack(
                          ...
                          children: <Widget>[
                            TextButton(
                              ...
                              onPressed: () async {
                                isDiscoveringServices[device.remoteId] ??=
